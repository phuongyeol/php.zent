...
<?php 
    function send_email($email_recive,$name,$contents,$subject ){
        ...
        $mail->SetFrom("auto.zentgroup@gmail.com", "Zent Group-PHP 10"); // Thông tin người gửi
        $mail->AddReplyTo("auto.zentgroup@gmail.com", "Zent Group-PHP 10");// Ấn định email sẽ nhận khi người dùng reply lại.

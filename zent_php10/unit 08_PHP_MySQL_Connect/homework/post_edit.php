...
<div id="page-wrapper">
  <div class="container-fluid">
   ...
   <div class="form-group">
     ...
     <input type="number" class="form-control"  placeholder="" name="content" class="" value="<?php echo $row['content'] ?>">
   </div>
   <div class="form-group">
     <label for="">Image</label>
     <input type="number" class="form-control" placeholder="" name="image" class="" value="<?php echo $row['image'] ?>">
   </div>
   <div class="form-group">
     <label for="">Author</label>
     <input type="number" class="form-control" placeholder="" name="author" class="" value="<?php echo $row['author'] ?>">
   </div>

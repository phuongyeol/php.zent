<?php 
    ...
    $query .=" values('".$id."','".$title."','".$short_content."','".$content."','".$iamge."','".$author."')";
...
<script language=JavaScript>
    function checkInput() {
      if (document.frmPHP.id.value=="") {
        alert("Invalid ID, Please enter ID");
        document.frmPHP.id.focus();
        return false;
        }
      if (document.frmPHP.title.value=="") {
        alert("Please enter Title");
        document.frmPHP.title.focus();
        return false;
      }
        return true;
    }
...
<div id="page-wrapper">
  <div class="container-fluid">
    ...
    <form action="add.php" method="POST" role="form" onsubmit="return checkInput();">
     <legend>Add New Post</legend>

     <div class="form-group">
       <label for="">ID</label>
       <input type="text" class="form-control" id="id" name="id" class="">
     </div>
     <div class="form-group">

	...
	<table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
		    ...
		    if(isset($_SESSION["ten_nv"]))
		            {
		                echo "Xin chào: ".$_SESSION["ten_nv"];
		                echo "<br>";
			...
			<td height="49" valign="top"><form name="form1" method="post" action="">
				...
				<div align="center" class="container">
					<table class="table table-border">
						<input type="button" name="Button" class="btn btn-primary" value="Xem thông tin cá nhân" onClick="javascript:window.open('lab9_2.php','_self')">

...
<body>
    <div class="container">
        <form name="frmPHP" method="post" action="khachhang_dodelete.php" onsubmit="return checkInput();">
            <legend>20156275 - TRẦN THỊ PHƯƠNG</legend>

            <div class="form-group">
                <label for="">Mã khách hàng cần xóa:</label>

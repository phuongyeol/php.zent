  ...
  <nav class="navbar">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">PROJECT - PHP09</a>
      </div>
  ...
  <section>
    ...
    <aside id="leftsidebar" class="sidebar">
      ...
      <div class="user-info" style="background: url(upload/images/user-img-background.jpg);">
        <div class="image">
          <img src="upload/admin/staff/<?php echo $_SESSION['staff_login']['avatar'] ?>" width="48" height="48" alt="User" />
        </div>
        ...
        <ul class="list0">
          ...
          <li>
            <a href="javascript:void(0);" class="menu-toggle">
              ...
              <span>User Management (UM)</span>
            </a>
            <ul class="ml-menu">
              <li>
                <a href="?mod=customer">Customers</a>
              </li>
              <li>
                <a href="?mod=staff">Staff</a>
              </li>
              <li>
                <a href="?mod=job">Job</a>
              </li>             
            </ul>
          </li>
          <li>
            <a href="javascript:void(0);" class="menu-toggle">
              ...
              <span>Goods Management (GM)</span>
            </a>
            <ul class="ml-menu">
              <li>
                <a href="?mod=category">Category</a>
              </li>
              <li>
                <a href="?mod=product">Product</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="?mod=invoice">Revenue</a>
              </li>
              <li>
                <a href="javascript:void(0);" class="menu-toggle">Product</a>
                <ul class="ml-menu">
                  <li>
                    <a href="?mod=product&act=inventory">Inventory - Tồn</a>
                  </li>
                  <li>
                    <a href="?mod=product&act=goods_sold">Goods Sold - Chạy</a>
                  </li>
                </ul>
              </li>
            </ul>
      ...
      <div class="legal">
        <div class="copyright">
          &copy; 2018 - 2019 <a href="javascript:void(0);">Design by Anh Nguyentrung</a>.
        </div>
        <div class="version">
          <b>Version: </b> 1.0.5
        </div>
    ...
    <aside id="rightsidebar" class="right-sidebar">
      <ul class="nav nav-tabs tab-nav-right" role="tablist0">

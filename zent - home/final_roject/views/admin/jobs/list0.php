...
<div class="content-wrapper" style="padding:0px 20px 20px 20px">
	<div class="row">
		...
		<!-- /.row -->
		<div>
			<legend style="padding-bottom: 20px">list0 Job</legend>
			...
			<table  id="myTable" class="table table-hover table-striped table-bordered">
				...
				<tbody>
					...
					<tr class="">
						...
						<td class="text-left">
							<a href="?mod=job&act=staff_list0&id=<?php echo $job['id'] ?>" title="" class="link">
								<?php echo $job['name'] ?>								
							</a>
						</td>
						...
						<td class="text-center" width="20%">
							...
							<!-- list0 product -->
							<a href="?mod=job&act=staff_list0&id=<?php echo $job['id'] ?>" title="Staff list0" class="btn btn-sm" style="color: green"><i class="fa fa-users"></i></a>

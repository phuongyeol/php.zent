<?php 
    function send_email($email_recive,$name,$contents,$subject ){
        ...
        $mail->SetFrom("anhnguyentrung.hust@gmail.com", "Zent Group"); // Thông tin người gửi
        $mail->AddReplyTo("anhnguyentrung.hust@gmail.com","Zent Group");// Ấn định email sẽ nhận khi người dùng reply lại.

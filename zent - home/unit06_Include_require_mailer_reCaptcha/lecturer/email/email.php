<?php 
	function send_email($email_recive,$name,$contents,$subject ){
        ...
        $mail->SetFrom("anhnguyentrung.hust@gmail.com", "Nguyen Trung Anh"); // Thông tin người gửi
        $mail->AddReplyTo("anhnguyentrung.hust@gmail.com","Nguyen Trung Anh");// Ấn định email sẽ nhận khi người dùng reply lại.
    ...
    ";
	send_email("anhngtrung@gmail.com", $name, $msg, "Test mail");

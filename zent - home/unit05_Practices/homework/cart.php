...
<body>
	<div class="container">
		...
		<table class="table table-hover">
				...
				<?php if (isset($_SESSION['cart'])):  
					...
					<?php foreach ($_SESSION['cart'] as $key => $product) { 
						...
						<tr>
							...
							<!-- cách 2: truyền thêm 1 biến action del_all để xác nhận xóa hêt
								<a href="delete.php?code=<?php  $key ?>&action=del_all" title="" type="button" class="btn btn-danger">Delete all</a> -->
							</td>
						</tr>
						<?php } ?>
			...
			<div class="alert alert-success">
				<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
				<strong>Info!</strong><?php echo "Giỏ hàng hiện không có sản phẩm nào" ?>
			</div>
			<?php } ?>
			<?php } ?>

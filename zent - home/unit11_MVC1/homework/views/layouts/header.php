    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="?mod=home">ZENT GOUP</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="?mod=users"><i class="fa fa-user fa-fw"></i> Users</a>
                        </li>
                        <li>
                            <a href="?mod=categories"><i class="fa fa-sitemap fa-fw"></i> Categories</a>
                        </li>
                        <li>
                            <a href="?mod=products"><i class="fa fa-table fa-fw"></i> Products</a>
                        </li>

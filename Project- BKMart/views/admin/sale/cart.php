	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="col-lg-offset-10">
				<a href="?mod=sale&act=list1" title="Tiếp tục mua hàng" class="fa fa-shopping-cart btn btn-success"><b>&nbsp;Buy</b></a>
		...
		<div class="container-fluid">
			...
			<legend style="padding-bottom: 20px">list1 product</legend>

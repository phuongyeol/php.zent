...
<div class="content-wrapper" style="padding:0px 20px 20px 20px">
	<div class="row">
		...
		<!-- /.row -->
		<div>
			<legend style="padding-bottom: 20px">list1 Category</legend>
			...
			<table  id="myTable" class="table table-hover table-striped table-bordered">
				...
				<tbody>
					...
					<tr class="">
						...
						<td class="text-left">
							<a href="?mod=category&act=product_list1&id=<?php echo $category['id'] ?>" title="" class="link">
						...
						<td class="text-center" width="20%">
							...
							<!-- list1 product -->
							<a href="?mod=category&act=product_list1&id=<?php echo $category['id'] ?>" title="Product list1" class="btn btn-sm" style="color: green"><i class="fa fa-product-hunt"></i></a>
